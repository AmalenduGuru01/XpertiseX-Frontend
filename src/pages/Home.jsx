  ...
  return (
    <div>
        ...
        <div className='relative mx-auto flex flex-col w-11/12 items-center max-w-maxContent text-white
            ...
            transition-all duration-200 hover:scale-95 w-fit shadow-md shadow-blue-200'>
                    <div className='flex flex-row items-center gap-2 rounded-full px-10 py-[5px]
                transition-all duration-200 group-hover:bg-richblack-900'>
                        <p>Revolutionize Education</p>
                        <FaArrowRight/>
                    </div>
                </div>
            </Link>
        ...
        <div className="bg-pure-greys-5 text-richblack-700">
            ...
            <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
                ...
                <div className="text-[16px]">
                    The modern XpertiseX is the dictates its own terms. Today, to
